  ...
  return (
    <div className="bg-dark-100 w-full flex p-4 rounded-md justify-between">
      ...
      {userLength || invite ? (
        <button
          disabled
          className="bg-green-300 my-2 p-2 w-lg rounded-lg flex gap-1 justify-center"
        >
        ...
        <button
          disabled
          className="bg-red my-2 p-2 w-lg rounded-lg flex gap-1 justify-center"
        >
          <CircleSlash /> blocked
        </button>
      ) : (
        <button
          className="bg-green-100 m-2 p-2 w-lg rounded-lg flex gap-1 justify-center"
