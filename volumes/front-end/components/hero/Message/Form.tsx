        ...
        >
            <div className='bg-dark p-8 space-y-4 w-11/12 sm:w-[500px] rounded-md'>
                <div className='space-y-4'>
                    ...
                    <p>Send a message to <span>Amrakibe</span></p>
                </div>
                <form className='flex flex-col gap-4' onSubmit={forwordSubmit}>
                    <div>
                        <textarea
                            ...
                            onChange={setMessage}
                        />
                        {error ? <span className='text-xs text-red capitalize'>we can't send empty message</span> : null}
                    </div>
