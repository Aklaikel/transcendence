...
export default function Login() {
    ...
    return (
        <div ref={vantaRef} className="h-screen w-screen  grid place-content-center overflow-x-hidden bg-dark text-white">
            {/* <div className="w-full h-full bg-[url('/fortnite.jpg')] bg-cover max-sm:hidden"></div> */}
            <div className="text-center space-y-7">
                <div>
                    <Image src="/logo.svg" width={100} height={30} alt='/' className="m-auto" />
                </div>
                <div className="text-center space-y-7">
                    ...
                    <Link
                        href="http://localhost:8000/42/oauth" className="flex outline-0 items-center hover:shadow-xl hover:bg-[#BE4FC2] px-5 sm:px-10 m-auto bg-[#F4F4F4] h-[60px]  rounded-[60px] text-dark font-blod w-fit">
