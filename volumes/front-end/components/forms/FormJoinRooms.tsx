...
export default function FormJoinRoom() {
  ...
  return (
    <div>
      <form className="mt-5" onSubmit={(e: any) => goToRoom(e)}>
        ...
        <button
          className={`text-center ${!password || password.length <= 3 ?"bg-[#03C988]/50" :"bg-[#03C988] "} mt-5 w-full p-3 rounded-lg  flex justify-center space-x-3 items-center`}
          type="submit"
