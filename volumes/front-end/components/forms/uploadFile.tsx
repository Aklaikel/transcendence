    ...
    >
     ...
     <div>
        ...
        <div className="max-w-[180px] text-center hidden md:block space-y-8">
            <div>
                <Icon name="fileAvatarUpload.svg" width={100} className="mx-auto" />
        ...
        >
            ...
            <span className='flex md:hidden justify-center gap-2'> <Icon name='fileAvatarUpload.svg'/> Upload Avatar</span>
        </div>
